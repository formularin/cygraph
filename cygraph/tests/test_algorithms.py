...
# This graph has 5 vertices and has edges between all comibinations of vertices.
...
for graph in [g for s in SAMPLE_GRAPHS_1 for g in SAMPLE_GRAPHS_1[s].values()]:
...
for graph in [g for s in SAMPLE_GRAPHS_2 for g in SAMPLE_GRAPHS_2[s].values()]:
...
def test_find_articulation_points():
    ...
    for static in SAMPLE_GRAPHS_2:
        g1 = SAMPLE_GRAPHS_2[static]['directed']
        with pytest.raises(NotImplementedError):
            find_articulation_points(g1)
        
        g2 = SAMPLE_GRAPHS_2[static]['undirected']
...
def test_partition_graph():
    ...
    for static in SAMPLE_GRAPHS_1:
        ...
        g = SAMPLE_GRAPHS_1[static]['directed']
        with pytest.raises(NotImplementedError):
            partition_graph(g)

    for graphs in SAMPLE_GRAPHS_1.values():
